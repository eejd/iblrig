...
REWARD_BLOCK_AMOUNT_SET = [1, 1, 1, 2, 2, 2] # for alternative reward block, multiplier per contrast level
...
REWARD_RPE_PROBABILITY = 0.05 # probability of changing the expected reward (regardless)
...
# CONTRASTS
CONTRAST_SET = [1., 0.25, 0.125, 0.0625, 0.]  # Full contrast set, used if adaptive contrast = False  # noqa
REPEAT_CONTRASTS = [1., 0.5]  # Contrasts to be repeated if error
# ADAPTIVE_CONTRAST PARAMETERS (IGNORED IF ADAPTIVE_CONTRAST = False)
ADAPTIVE_CONTRAST = False  # Whether to use Adaptive contrast rule or not (not used for RPE pilot)
